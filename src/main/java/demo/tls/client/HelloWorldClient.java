...
public class HelloWorldClient {
    ...
    private static SslContext buildSslContext() throws SSLException {
        String clientCertChainFilePath = "/opt/gopath/src/github.com/zhangyangMr/grpc-mutual-tls-demo/src/main/openssl/client.crt";
        String clientPrivateKeyFilePath = "/opt/gopath/src/github.com/zhangyangMr/grpc-mutual-tls-demo/src/main/openssl/client.pem";
    ...
    public HelloWorldClient() throws SSLException {
        ...
        this(NettyChannelBuilder.forAddress("hello.world.com", 50051)
